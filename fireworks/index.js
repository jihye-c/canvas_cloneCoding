...
class Canvas extends CanvasOption{
    ...
    createTail(){
        const x = randomNumBetween(this.canvasWidth * 0, this.canvasWidth);
    ...
    createParticles(x, y, colorDeg){
        ...
        for (let i = 0; i < PARTICLE_NUM; i++){
            const r = randomNumBetween(2,80) * hypotenuse(innerWidth, innerHeight) * 0.00012;
    ...
    render(){
        ...
        const frame = () => {
            ...
            this.ctx.fillStyle = `rgba(255,255,255,${this.particles.length / 45000})`
            this.ctx.fillRect(0,0,this.canvasWidth,this.canvasHeight);
            ...
            this.tails.forEach((tail, index)=>{
                ...
                for(let i = 0; i< Math.round(-tail.vy * 0.5); i++){
                    ...
                    const opacity = Math.min(-tail.vy * 0.1, 0.5)
            ...
            this.particles.forEach((particle, index) => {
                ...
                if(Math.random() < 0.1) this.sparks.push(new Spark(particle.x, particle.y, 0, 0, 0.3));
